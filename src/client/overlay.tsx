...
export function OverlayToolbar({ onCapture, onInspect }: { onCapture?: () => void; onInspect?: () => void }) {
  ...
  return React.createElement(
    ...
    React.createElement('span', { style: { color: 'var(--dsw-alias-label-secondary)', font: 'var(--dsw-font-s-regular-14, 400 14px / 20px var(--dsw-font-family-base))', padding: '0 3px' } }, 'DevKit'),
  );
}
